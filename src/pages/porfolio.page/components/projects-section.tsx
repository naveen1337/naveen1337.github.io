  ...
  return (
    <div className="py-6 px-20">
      <div className="inline-block pb-2">
        <p className="text-[28px]  tracking-widest pt-2 text-white">Projects</p>
      ...
      <div className="grid grid-cols-12 py-4 gap-4">
        <div className="col-span-4 bg-gradient-to-r border-l-8 border-primary from-[rgba(0,0,0,0.8)] p-3 pr-3  to-[rgba(0,0,0,0.2)]">
          <ProjectCard
