    ...
    <div className={ss.root}>
      <div className={ss.block1}>
        ...
        <p className={ss.content}>
          Expertise in Full Stack web developement React, Node.js, Postgres, Python React Native and Linux
...
const ss = {
  ...
  heading: "text-[22px] md:text-[22px] tracking-wider inline-block  pt-2 text-white",
  border: "bg-gradient-to-r from-secondary to-primary rounded h-1 ease-linear",
  mainTitle: "text[20px] md:text-lg py-4 font-med text-white",
  content: "text[20px] md:text-base pb-4 text-white",
