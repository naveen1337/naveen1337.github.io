export default function AriticleList() {
  return (
    <div className="pb-3 border-b border-l-4 my-2 border-l-primary border-gray-700">
      <div className="pl-4">
        <p className="pb-2 text-white text-xl font-medium">
          SQLite as a File system
        </p>
        <div className="flex pb-2 flex-row items-center space-x-6">
          <p className="text-gray-200 text-sm">March 28 2025</p>
          <p className="text-gray-200 text-sm">25 min read</p>
        </div>
